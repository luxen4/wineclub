...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 03-01-2024 a las 20:50:11
...
(6, 'BAJEXIS6', 1, 2, 21, 5, '2023-12-27 22:58:00'),
(7, 'BAJEXIS7', 1, 1, 21, 10, '2023-12-27 23:47:23'),
(8, 'BAJEXIS8', 1, 2, 21, 5, '2023-12-27 23:49:36');
...
(23, 'CAT23', 'Mi catalogación', '1'),
(24, 'CAT24', 'Mi ctalogación', '1'),
(25, 'CAT25', 'rthrthergergeg', '1');
...
(21, 1, 'CPRO21', '2023-12-27 22:57:14'),
(22, 1, 'CPRO22', '2023-12-27 23:28:28'),
(23, 1, 'CPRO23', '2023-12-27 23:33:49'),
(24, 1, 'CPRO24', '2023-12-30 01:11:27');
...
(7, 'EMP7', 'Aoito', 'Pérez', 'Martínez', '606999999', 'aoito@aoito.com', 'Hombre', '1970-04-26', 'aoito', '6QRNJHgiEptBfbMM4eaHEFkCctQ=', 3, '1');
...
(10, 'LCP10', 5, 1, 100, '8.30', '11.61'),
(11, 'LCP11', 6, 35, 100, '4.00', '6.94'),
(12, 'LCP12', 7, 1, 100, '8.40', '11.91'),
(13, 'LCP13', 8, 30, 10, '3.00', '4.00'),
(14, 'LCP14', 9, 19, 8, '2.00', '4.99'),
(15, 'LCP15', 11, 19, 25, '2.00', '3.09'),
(16, 'LCP16', 12, 6, 100, '1.00', '2.00'),
(17, 'LCP17', 17, 1, 100, '9.10', '13.51'),
(18, 'LCP18', 18, 1, 100, '8.40', '12.81'),
(19, 'LCP19', 19, 3, 8, '3.00', '8.00'),
(20, 'LCP20', 20, 5, 3, '5.00', '4.00'),
(21, 'LCP21', 21, 1, 100, '8.53', '10.99'),
(22, 'LCP22', 22, 2, 7, '0.00', '0.00'),
(23, 'LCP23', 23, 10, 100, '2.00', '3.00'),
(24, 'LCP24', 24, 4, 100, '1.00', '2.00');
...
(1, 'LVP1', 1, 24, 1, 2, '10.99'),
(2, 'LVP2', 1, 24, 2, 3, '19.49'),
(3, 'LVP3', 1, 24, 3, 3, '7.30'),
(4, 'LVP4', 1, 24, 4, 3, '2.00'),
(5, 'LVP5', 2, 4, 1, 5, '10.99'),
(6, 'LVP6', 2, 4, 2, 3, '19.49'),
(7, 'LVP7', 2, 4, 3, 2, '7.30'),
(8, 'LVP8', 3, 24, 1, 2, '10.99'),
(9, 'LVP9', 3, 24, 4, 1, '2.00'),
(10, 'LVP10', 4, 21, 1, 19, '10.99'),
(11, 'LVP11', 5, 2, 2, 50, '19.49'),
(12, 'LVP12', 6, 2, 2, 3, '19.49');
...
(1, 'PRO1', 'PAGOS DEL REY', 'C. Somillo (Paraje La Balsa), 01309', 'Bilar', 'Álava', '945600693', 'https://www.altosderioja.com/', '0'),
...
(10, 'PRO10', 'Emilio Moro SL', 'Ctra. Peñafiel-Valoria, S/N, 47315', 'Pesquera de Duero', 'Valladolid', '983 87 84 00', 'https://www.emiliomoro.com/', '0'),
(12, 'PRO12', 'Freixenet S.A.', 'Carrer de Joan Sala, 2, 08770', 'Sant Sadurní d Anoia', 'Barcelona', '938 91 70 00', 'https://freixenet.com/es/', '1'),
(13, 'PRO13', 'LUSTRAU', '*', '*', '*', '*', '*', '0'),
(15, 'PRO15', 'VALL DE JUY', '*', '*', '*', '*', '*', '1'),
(16, 'PRO16', 'GONZALEZ BYASS', '*', '*', '*', '*', '*', '1'),
(17, 'PRO17', 'Felix Solis. S.L.', 'Autovía del Sur, Km. 199, 13300', 'Valdepeñas', 'Ciudad Real', '926 32 24 00', 'https://www.felixsolis.com/', '1'),
(18, 'PRO18', 'LOS CORZOS', 'Pol. Casablanca, nave 41-42.', 'Laguardia', 'Álava', '945 62 50 55', 'https://bodegaloscorzos.es/', '1'),
...
(26, 'PRO26', 'BORN ROSÉ Barcelona', '*', '*', '*', '*', '*', '0');
...
(5, 'SOC5', 'RaulA', 'Moreno Espinosa', 'Santander', 'Cantabria', 'Hombre', '55555555-M', '606000005', 'raul@gmail.com', 'Si', '0'),
(6, 'CLS6', 'Paco', 'Omaita Moranco', 'Écija', 'Sevilla', 'Hombre', '16600000W', '606999888', 'paco@gmail.com', 'Si', '0'),
(7, 'CLS7', 'Paco', 'Omaita Moranco', 'Écija', 'Sevilla', 'Hombre', '16600000W', '606999888', 'paco@gmail.com', 'Si', '1');
...
(1, 'VSO1', 6, 1, '2023-12-30 01:12:16'),
(2, 'VSO2', 1, 1, '2024-01-03 11:49:44'),
(3, 'VSO3', 1, 2, '2024-01-03 11:53:58'),
(4, 'VSO4', 1, 4, '2024-01-03 19:19:51'),
(5, 'VSO5', 1, 4, '2024-01-03 19:22:38'),
(6, 'VSO6', 1, 7, '2024-01-03 19:40:33');
...
--
ALTER TABLE `compraproveedor`
  MODIFY `id_compraproveedor` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=25;
...
--
ALTER TABLE `empaquetado`
  MODIFY `id_empaquetado` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=12;
...
--
ALTER TABLE `formatocontenido`
  MODIFY `id_formatocontenido` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=24;
...
--
ALTER TABLE `rollempleado`
  MODIFY `id_rollempleado` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;
...
--
ALTER TABLE `tipouva`
  MODIFY `id_tipouva` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=33;
...
--
ALTER TABLE `ubicacionlineacompraproveedor`
  MODIFY `id_ubicacionlinearcompraproveedor` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=171;

--
-- AUTO_INCREMENT de la tabla `variedaduva`
--
ALTER TABLE `variedaduva`
  MODIFY `id_variedaduva` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
