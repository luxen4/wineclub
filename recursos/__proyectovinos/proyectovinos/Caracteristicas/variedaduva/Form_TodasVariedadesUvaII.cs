...
{
    public partial class Form_TodasVariedadesUvaII : Form
    {
        public Form_TodasVariedadesUvaII()
        {
            InitializeComponent();
        }
        ...
        private void Form_TodasVariedadesUvaII_Load(object sender, EventArgs e)
        {
            this.CenterToScreen();
