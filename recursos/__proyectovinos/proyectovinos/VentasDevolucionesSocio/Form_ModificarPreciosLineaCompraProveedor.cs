...
namespace proyectovinos.VentasDevolucionesSocio
{
    public partial class Form_ModificarPreciosLineaCompraProveedor : Form
    {
        ...
        private int /*id_compraproveedor = 0,*/ id_proveedor = 0;
        private string /*refCompraProveedor,*/ nombreProveedor, refArticulo, nombreCatalogacion, refLinea;
        ...
        private void combo_refarticulo_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            pictureBox1.Image = Image.FromFile(@"../../img/proveedores/" + id_proveedor + "/articulos/" + nombreClaseVino + "/" + refArticulo + ".jpg");
        ...
        {
            // Copiado a modificación de precios de una línea
          
            string refProveedor = consultas.obtenerCualquierRefDesdeNombre("ref", "proveedor", "nombre", nombreProveedor);
